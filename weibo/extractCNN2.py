...
if __name__ == "__main__":
    ...
    fw = open('/home/gexuri/VisualSearch/weibotest/FeatureData/pyresnet152-pool5osl2/feature-50.bin','wb')
    wff = open('/home/gexuri/VisualSearch/weibotest/FeatureData/pyresnet152-pool5osl2/wrong_pic.txt', 'w')
    ...
    rf = open('/home/gexuri/VisualSearch/weibotest/FeatureData/pyresnet152-pool5osl2/id.txt', 'r')
    line = rf.readline()
    rf.close()
